...
pub fn setup_hook(app: &mut App) {
    ...
    build_notifications_window(app).expect("should build notifications window");
}
...
fn build_notifications_window(app: &mut App) -> Result<()> {
    ...
    .title("Notifications")
    .inner_size(384f64, 48f64)
    .max_inner_size(384f64, 48f64)
    .min_inner_size(384f64, 48f64)
    .fullscreen(false)
    .resizable(false)
    .decorations(false)
    .always_on_top(true)
