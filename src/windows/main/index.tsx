...
const Content: React.FC = () => {
  return (
    <div className="w-[20rem] h-[21rem]">
      <div className="w-screen h-screen flex flex-col bg-window/95 border-2 border-primary/5 rounded-md overflow-clip">
        {/* Titlebar */}
        <div className="flex flex-row items-center h-8 p-0.5 bg-primary/5">
